            ...
            <div>
                ...
                <div class="content">
                    ...
                    <div class="c_detail_header" style="overflow: hidden;">
                        <table class="table_detail_header" style="width: 2055px;table-layout: fixed;">
                            <thead>
                                <tr class="header">
                                    ...
                                    <th style="width: 120px;">販売手数料率</th>
                                    <th style="width: 140px;">販売手数料見積額</th>

                                    <th style="width: 120px;">配送代行<br>手数料区分</th>
                                    <th style="width: 120px;">配送代行<br>手数料見積額 </th>
                                    <th style="width: 137px;">手数料見積合計</th>
                    ...
                    <div class="c_detail_content" style="overflow: auto;display: display;" onscroll="scrollHead(this);">
                        <table class="table_detail_content" style="width: 2038px;table-layout: fixed;" id="stocktable">
                            <tbody>
