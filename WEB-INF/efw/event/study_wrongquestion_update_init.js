var study_wrongquestion_update_init = {};
study_wrongquestion_update_init.name = "納品情報管理画面初期表示";
study_wrongquestion_update_init.paramsFormat = {


};

study_wrongquestion_update_init.fire = function (params) {
