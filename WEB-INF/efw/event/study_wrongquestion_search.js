var study_wrongquestion_search = {};
study_wrongquestion_search.name = "納品情報管理画面初期表示";
study_wrongquestion_search.paramsFormat = {


};

study_wrongquestion_search.fire = function (params) {
