var labelprinting_queryproductsub = {};
labelprinting_queryproductsub.name = "LABEL印刷画面";
labelprinting_queryproductsub.paramsFormat = {
...
labelprinting_queryproductsub.fire = function (params) {
	...
	if(opt == '0'){
		...
		// ret.runat("#labelprinting_inputdialog").withdata( {"#text_productname":null});
				...
				if(selectResult1.length == 1){
					...
					if(selectResult2.length > 0){
						...
						if(selectResult2.length == 1){
							...
							// ret.runat("#labelprinting_inputdialog").withdata( {"#text_productname":selectResult3["productname"]});
						}
	...
	if(opt == '1'){
		...
		// 	ret.runat("#labelprinting_inputdialog").withdata( {"#text_productname":selectResult["productname"],})
		// }
	}
