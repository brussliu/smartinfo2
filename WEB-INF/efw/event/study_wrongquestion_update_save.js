var study_wrongquestion_update_save = {};
study_wrongquestion_update_save.name = "納品情報管理画面初期表示";
study_wrongquestion_update_save.paramsFormat = {


};

study_wrongquestion_update_save.fire = function (params) {
