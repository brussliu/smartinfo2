<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <div class="dialog" id="earnings_detail_inputdialog" style="display:block;background-color: rgb(255,255,240);">
        ...
        <div style="width: 96%;height: 96%;margin: 10px;">
            <p style="line-height: 40px;"><span>YYYY年MM月</span></p>
               ...
               <div>
                ...
                <div>
                   ...
                   <div>
                    ...
                    <div style="height:57px;overflow-y: auto;">
                    <table  >
                        <tbody>
                           <tr>
...
<!--  -->
<div class="div_tab div_tab2" style="border-left: 1px solid black;"> 
        <div>
         <p  style="background-color:#ff6464;"><span>仕入</span></p>
         <div style="height: 166px;overflow-y: auto;">
         <table >
             <tbody>
                 <tr>
                     <td><span >2023/1/23</span></td>
     ...
     </div><div class="div_tab div_tab2"> 
